...
* **Sideloading || TrollStore (No Jailbreak):**
    ...
    1. Download IPA file from here and follow the instructions below to sign and install the app from your computer for one week
        ...
        | ------------------ |:---------:|:------:|:------:|:------:|
        | [YouTube](https://ikghd.site/ipa/YouTube_19.45_YTKillerPlus_3.2.37.ipa) | com.google.ios.youtube | 19.45 | 3.2.37 | IPA |
        | [TrollStore](https://ikghd.site/ipa/YouTube_19.45_YTKillerPlus_3.2.37_TrollStore.tipa) | com.google.ios.youtube | 19.45| 3.2.37 | tipa |
...
* Right click on the AltServer icon with your phone connected and choose "Install Altstore", then the name of your phone. When prompted sign in with your Apple ID. Two-factor Authentication is supported, app-specific passwords are not.
    ...
    * [Open In AltStore YTKillerPlus v19.45](https://tinyurl.com/nvmws73b) this will take some time as it altstore need to download the iPA and it depending on the internet connection speed .
...
* Copy this link [here](https://ikghd.site/ipa/YouTube_19.45_YTKillerPlus_3.2.37_TrollStore.tipa) and paste it into the "Install from URL" option in TrollStore.
